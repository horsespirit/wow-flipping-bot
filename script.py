...
def login_e_analizza():
    ...
    try:
        ...
        html = "<html><head><style>body{font-family:sans-serif;background:#121212;color:white;padding:20px} .cat-box{border:1px solid #444;margin-bottom:20px;padding:15px;border-radius:8px} .buy{color:#4caf50} .sell{color:#f44336} table{width:100%;border-collapse:collapse} td{padding:5px}</style></head><body>"
        html += "<h1>Dashboard Strategica WoW</h1>"
        ...
        with open("index.html", "w") as f:
            f.write(html)
        print("Fatto! File index.html generato.")
